  ...
  return (
    <main className="profile-page">
      ...
      <article className="profile-sheet">
        ...
        <section className="profile-grid">
          <div className="profile-main">
            ...
            <section>
              ...
              <div className="profile-entry"><span>2026.06</span><strong>NAVER billboard.js</strong><p>Tooltip 버그 수정이 공식 저장소에 반영됨</p><a href="https://github.com/naver/billboard.js/commit/d7cba7f391c83a47168e8c9d45a15a7c1b42caf1" rel="noreferrer" target="_blank">반영 커밋 <code>d7cba7f</code> <ExternalLink size={10} /></a></div>
            </section>
          </div>
          ...
          <aside>
            ...
            <section>
              ...
              <p>모의투자대회 49,466명 중 320위<br />Top 500 · 2026</p>
            </section>
            <section>
              <h2>GitHub</h2>
        ...
        <footer><span>Dojang 인증 지갑의 참여를 기록하는 온체인 마당</span><span>WADANG · 2026</span></footer>
      </article>
    </main>
  );
}
