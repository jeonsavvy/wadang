    ...
    <main className="deck-page">
      ...
      <section className="deck-slide deck-cover">
        <DeckChrome number={1}>
          ...
          <h1>Dojang 검증을 참여와<br />접근 자격으로 잇는 <em>WADANG</em></h1>
          <p>캠페인에서 시작해 검증된 지갑의 참여 결과를 다른 GIWA 앱이 다시 사용할 수 있게 합니다.</p>
      ...
      <section className="deck-slide deck-insight">
        <DeckChrome number={3}>
          <div className="deck-tag">TRUST → RULE → ACCESS</div>
          <h2>검증 정보와 참여 규칙의<br /><em>역할을 나누고 다시 연결합니다.</em></h2>
          ...
          <p className="deck-quote">WADANG은 <code>isVerified</code>를 복제하지 않고, 검증 결과가 실제 참여와 접근으로 이어지는 과정을 만듭니다.</p>
        </DeckChrome>
      </section>
      ...
      <section className="deck-slide deck-architecture">
        <DeckChrome number={6}>
          <div className="deck-side-label">COMPOSABLE ACCESS</div>
          <h2>한 번의 참여 결과를<br /><em>다른 앱이 접근 조건으로 사용합니다.</em></h2>
          ...
          <div className="deck-boundaries"><span>현재 참여 기록</span><span>현재 인증 상태</span><span>마당 취소 여부</span><span>외부 앱 연동 테스트</span></div>
        </DeckChrome>
      </section>

      <section className="deck-slide deck-market">
        <DeckChrome number={7}>
          <div className="deck-tag">WEDGE → PRODUCT → INFRASTRUCTURE</div>
          <h2>캠페인에서 시작해<br /><em>참여·접근 인프라로 확장합니다.</em></h2>
          <div className="deck-market-grid">
            <article><span>01 · MVP</span><h3>검증 지갑 캠페인</h3><p>Verified Address 한 종류로 참여 규칙과 재사용 가능한 결과를 검증합니다.</p></article>
      ...
      <section className="deck-slide deck-roadmap">
        <DeckChrome number={8}>
          ...
          <div className="deck-timeline"><div><small>AUG</small><strong>Wallet UX + 첫 파트너</strong><p>만료·취소·재인증 흐름을 GIWA와 검토</p></div><div><small>SEP</small><strong>파일럿 운영</strong><p>참여 완료율과 연동 수요 확인</p></div><div><small>OCT</small><strong>인증 유형 확장 검토</strong><p>Verified Balance·Code 적용 범위 결정</p></div></div>
        </DeckChrome>
      </section>
      ...
      <section className="deck-slide deck-team">
        <DeckChrome number={9}>
          ...
          <div className="deck-team-grid">
            <div><h2>전찬혁<br /><em>JEON CHAN HYUK</em></h2><p>Product · Smart Contract · Frontend</p><div className="deck-proof-list"><span>Coupang Catalog Operation</span><span>NAVER billboard.js contributor</span><span>14 contract scenarios</span><span>Public source and documentation</span></div></div>
            <div className="deck-ask"><small>SUPPORT REQUEST</small><h3>GIWA Wallet UX 리뷰</h3><h3>Attester 운영 가이드</h3><h3>생태계 파일럿 파트너 1곳</h3><p>Wallet 안에서 캠페인을 찾고 참여하는 흐름, 인증 만료·취소 시 안내 방식, 첫 파일럿 운영을 GIWA 팀과 함께 검토하고 싶습니다.</p></div>
          </div>
          <div className="deck-end"><WadangMark size={22} /> WADANG · Dojang 검증을 참여와 접근 자격으로 연결하는 온체인 마당</div>
        </DeckChrome>
      </section>
    </main>
  );
